...
def initGame():
    ...
    setup.GRAPHICS = tools.load_graphics(os.path.join("resources", "graphics"))
    setup.SOUND = tools.load_all_sound(os.path.join("resources", "sound"))
    setup.MUSIC = tools.load_all_music(os.path.join("resources", "music"))
